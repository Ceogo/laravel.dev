...
<head>
    ...
    <style>
        :root {
            --primary: #36ba6b;       /* Основной цвет */
            --accent: #eaa360;        /* Акцентный цвет */
            --background: #fff;       /* Фон */
            --text-dark: #333;        /* Темный текст */
            --text-light: #666;       /* Светлый текст */
            --gray-light: #f5f5f5;    /* Светло-серый */
            --gray-mid: #e0e0e0;      /* Средний серый */
            --sidebar-dark: #1a202c;  /* Темный фон сайдбара */
            --sidebar-light: #2d3748; /* Светлый оттенок сайдбара */
        }
        ...
        .menu-item {
            ...
            color: var(--background); /* Белый текст */
        }
        .menu-item:hover {
            background: rgba(255, 255, 255, 0.1);
            transform: translateX(5px);
            border-left-color: var(--primary); /* Основной цвет при наведении */
        }
        .menu-item.active {
            background: rgba(54, 186, 107, 0.2); /* Прозрачный оттенок --primary */
        ...
        /* Основной контент */
        body {
            color: var(--text-dark); /* Темный текст */
        }
        .main-content {
            background-color: var(--background); /* Белый фон контента */
        }
        h2 {
            color: var(--text-dark);
        }
...
<body class="font-sans">
    ...
    <div class="fixed inset-y-0 left-0 w-64 sidebar md:transform-none z-50" id="sidebar">
        ...
        <nav class="mt-4">
            <a href="{{ route('document') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('document') ? 'active' : '' }}">
            ...
            <a href="{{ route('edit_data') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('edit_data') ? 'active' : '' }}">
            ...
            <a href="{{ route('schedule') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('schedule') ? 'active' : '' }}">
            ...
            <a href="{{ route('upload') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('upload') ? 'active' : '' }}">
            ...
            <a href="{{ route('teachers.index') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('teachers.index') ? 'active' : '' }}">
            ...
            <a href="{{ route('cabinets.index') }}" class="menu-item flex items-center px-4 py-3 transition {{ request()->routeIs('cabinets.index') ? 'active' : '' }}">
